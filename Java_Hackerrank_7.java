...
Each line  i of the  q subsequent lines contains three space-separated integers describing the respective a base i(ai) , bi, and ni  values for that query.
